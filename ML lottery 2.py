...
def train_and_predict_lottery_numbers_xgboost(file_path, future_draws=3):
    ...
    print(f"Predicted lottery numbers using XGBoost for the future ({future_draws} draws):")
...
train_and_predict_lottery_numbers_xgboost('C:\Lottery\Lotto.csv', future_draws=12)
